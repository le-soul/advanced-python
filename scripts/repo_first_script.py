...
def filter_all(df, month=None, year=None, price=None):
    """
...
def main(filename, output, filtering, analysis, price, month, year, graph, cleaning, display, clean):
    """
    Main function
    """
    ...
    if filtering:
        df = filter_all(df, month, year, price)
